...
parameterDict.update({'KPHIT' : Parameter(name='KPHIT',bname='kphit',type='Variable',family='',measurement='',unit='unitless',value='..KPhiT',mode='In',description='Description',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:rt_a1
#Family:
#Unit:unitless
...
parameterDict.update({'RT_A1' : Parameter(name='RT_A1',bname='rt_a1',type='Variable',family='',measurement='',unit='unitless',value='..RT_A1',mode='In',description='Description',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:tvdss
...
parameterDict.update({'TVDSS' : Parameter(name='TVDSS',bname='tvdss',type='Variable',family='True Vertical Depth Sub Sea',measurement='',unit='m',value='..TVDSS',mode='In',description='Description',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:swir
...
parameterDict.update({'SWIR' : Parameter(name='SWIR',bname='swir',type='Variable',family='Irreducible Water Saturation',measurement='',unit='v/v',value='..SWIR',mode='In',description='Description',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Number
#Unit:m
FWL_unit = u"m"
#Measurement:Depth
...
parameterDict.update({'HAFWL' : Parameter(name='HAFWL',bname='H',type='Variable',family='Height Above Free Water Level',measurement='',unit='m',value='..HAFWL',mode='Out',description='Description',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:swnj
...
parameterDict.update({'SWN_J' : Parameter(name='SWN_J',bname='swnj',type='Variable',family='Water Saturation',measurement='',unit='v/v',value='..SWN_J',mode='Out',description='Description',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:swj
#Family:Water Saturation
#Unit:v/v
...
parameterDict.update({'SW_J' : Parameter(name='SW_J',bname='swj',type='Variable',family='Water Saturation',measurement='',unit='v/v',value='..SW_J',mode='Out',description='Description',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
...
for loopIterator in loopRange:
	...
	if MissingValue not in [kphit, rt_a1, tvdss, swir] :
		...
		if FWL-tvdss > 0:
			if rt_a1 == 1:
				#swnj=10
				swnj = ((3.183*(FWL-tvdss)*(rho_w-rho_o)*0.098*sqrt(kphit))/(0.0643*y_cos_theta))**(1/-3.583)
			elif rt_a1 == 2:
				#swnj=20
				swnj = ((3.183*(FWL-tvdss)*(rho_w-rho_o)*0.098*sqrt(kphit))/(0.131*y_cos_theta))**(1/-4.325)
			elif rt_a1 == 3:
				#swnj=30
				swnj = ((3.183*(FWL-tvdss)*(rho_w-rho_o)*0.098*sqrt(kphit))/(0.1285*y_cos_theta))**(1/-5.323)
