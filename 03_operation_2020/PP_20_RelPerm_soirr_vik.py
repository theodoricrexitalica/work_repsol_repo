...
#Mode:In
#Description:Description
Soirr = Variable("10-R", "Slb_WLL", "SOWCR_pet", u"Irreducible Oil Saturation", u"v/v")
parameterDict.update({'Soirr' : Parameter(name='Soirr',bname='soirr',type='Variable',family='Irreducible Oil Saturation',measurement='',unit='v/v',value='10-R.Slb_WLL.SOWCR_pet',mode='In',description='Description',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Variable
#BName:swirr
...
for loopIterator in loopRange:
	...
	wor = MissingValue
	wco = MissingValue
	if MissingValue not in [rt, soirr, swirr, sw, visc_o, visc_w] :
